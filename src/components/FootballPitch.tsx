...
export default function FootballPitch({
  ...
  // Calculate the aspect ratio of a football pitch (typically around 105x68 meters)
  const aspectRatio = 105 / 68;

  return (
    <div
      className="relative w-full bg-green-700 rounded-lg overflow-hidden shadow-lg"
    ...
    >
      ...
      >
        ...
        {/* Left penalty arc */}
        <path
          d="M 16.5,25.3 A 9.15,9.15 0 0 1 16.5,42.7"
          fill="none"
          stroke="white"
          strokeWidth="0.3"
        />
        ...
        {/* Right penalty arc */}
        <path
          d="M 88.5,25.3 A 9.15,9.15 0 0 0 88.5,42.7"
          fill="none"
          stroke="white"
          strokeWidth="0.3"
        />
